  ...
  return (
    <LayoutWrap>
      <CardsWrap>
        ...
        <ImgWrap>
          <ContentImg src="https://i.pinimg.com/564x/ec/34/29/ec3429ae119bff957a7a0c330fddd1b0.jpg" alt="" />
        </ImgWrap>
        <IconWrap >
          <div onClick={likeHander}>
            {isLike === true ? <BsHeartFill size="24" color="#ff0000" /> : <BsHeart size="24" />}
          </div>
          <BsChat size="24" />
          <FiSend size="24" />
        </IconWrap>
        <div>
          <LikeNameWrap>
            ...
            <span><b>여기에 닉네임</b>님</span> 외 7명이 좋아합니다.
          </LikeNameWrap>
          <NickConstentWrap>
            <span><b>닉네임</b></span>
